...
const WIDGET_SRC = 'https://docs.emailagency.com/form/embed/js/form-embed/idom/docs.emailagency.com/akey/dd66202d-6b53-11ed-bdfa-fa163eff53f0/code/EACONTACT'
...
/**
 * LeadLogic form embed (EACONTACT campaign). Renders the #ll-form target
 * the vendor script populates, with a thick-border/grow-on-scroll
 * treatment on its fields. Reusable — the contact page and the homepage
 * both mount one of these, each getting its own populated form.
 *
