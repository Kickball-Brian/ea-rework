...
export const SOLUTIONS = [
    ...
    article: [
      {
        ...
        paragraphs: [
          "Most agencies sell lead generation as a numbers game: more clicks, more forms, more volume. That approach breaks down fast in legal, insurance, home services, home warranties, and personal injury. These are high-consideration, high-cost-per-acquisition categories, where a single bad lead can cost more than a week of ad spend, and where consumers only convert when the message, the timing, and the offer line up. Email Agency builds lead generation programs around that reality, not vanity metrics.",
          "Our approach draws on email marketing, affiliate and publisher networks, and direct outreach to reach people at the exact moment they're searching for a solution. That could be a claimant trying to understand a legal option, a homeowner with a broken HVAC system, a driver comparing insurance quotes, or a family trying to figure out what a home warranty actually covers. We build the acquisition strategy around the buyer's moment, not the other way around.",
        ],
      },
      {
        heading: 'Why High-CPA, Regulated Verticals Need a Different Playbook',
        paragraphs: [
          "Legal, insurance, home services, home warranty, and personal injury leads share a few traits that make generic lead gen risky: long sales cycles, real compliance requirements (TCPA, TSR, state insurance regulations, attorney advertising rules), and a buyer who is often stressed, uncertain, or comparing several providers at once. Volume without qualification doesn't remove the cost of a bad match. It just pushes that cost downstream, onto your intake team, your call center, or your sales staff.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Insurance lead generation lives and dies by seasonality, carrier appointments, and eligibility rules that shift by state and by product line. We build campaigns around those constraints: the right coverage type, the right geography, the right moment in a shopper's renewal or life-event cycle. That's how the leads reaching your agents end up being ones they can actually quote.",
          "Home services and home warranty leads are often urgent. A broken furnace in January doesn't wait for a follow-up email. We build campaigns that capture that urgency without letting it turn into low-intent noise: service-area targeting, fast delivery, and messaging that matches what a homeowner is actually dealing with, whether that's an emergency repair or a renewal decision.",
          "Personal injury shoppers are often reaching out at one of the most vulnerable moments in the funnel: recovering from an accident, dealing with an insurance adjuster, not sure whether they even have a case. We build campaigns that lead with clarity and screening instead of pressure, so the claimants who reach your intake team already understand what they're signing up for.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "That process runs on a feedback loop, not a set-and-forget campaign. We track lead quality all the way through to what happens after delivery: did the claimant qualify, did the policy bind, did the homeowner book the job. We use that data to refine targeting and creative on an ongoing basis. A source that produces cheap leads that never convert gets cut. A source that produces slightly more expensive leads that consistently close gets more budget.",
        ],
      },
      {
    ...
    article: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Set role-based permissions so intake staff, QA reviewers, and account managers each see exactly what they need and nothing they don't. Track a lead's full history, including source, qualifying answers, documents attached, and every status change, in a single record instead of scattered across email threads and spreadsheets.",
        ],
      },
      {
  ...
  },
  {
    ...
    article: [
      {
        heading: 'Trust Gets Built, or Lost, in the Feed',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          "Consumers in these verticals are wary of anything that feels like a sales pitch, especially around legal, medical, or financial decisions. We write and design content that informs first, covering what a process actually involves, what a coverage term actually means, what to expect from a service call, because content that helps outperforms content that just promotes, and it's more likely to get shared.",
        ],
      },
      {
        heading: 'Consistency Across Every Account',
        paragraphs: [
          "Whether you have one office or locations across multiple states, we keep messaging, compliance review, and brand voice consistent across every account we manage, so a follower's experience with your brand doesn't change depending on which page they land on. If you already have an audience, we start by learning what's resonated with them historically before changing direction, because rebuilding a following from scratch is slower and more expensive than redirecting one that already trusts you.",
        ],
      },
      {
        heading: 'Measuring What Matters',
        paragraphs: [
          "We report on the metrics that connect to pipeline: click-throughs to your site, messages and calls generated from social, review volume. Vanity metrics like impressions alone don't tell you whether the investment is translating into actual contact volume.",
        ],
      },
      {
        heading: 'Turning Social Proof Into Pipeline',
        paragraphs: [
          "Social media rarely closes a sale on its own in these verticals, but it does something just as useful: it removes the hesitation that keeps a ready buyer from picking up the phone or filling out a form. We track engagement and follower growth, but we manage toward the metric that actually matters, which is whether the account is reinforcing the trust your acquisition campaigns are trying to build, or working against it.",
        ],
      },
      {
  ...
  },
  {
    ...
    article: [
      ...
      },
      {
        ...
        paragraphs: [
          "Every site starts with the conversion path: the phone number, the intake form, the quote request, placed where a visitor actually looks, not buried in a navigation menu. Page speed gets treated as a conversion metric, not a technical afterthought, because a slow-loading site loses mobile visitors before they see anything else. Trust signals like licensing, certifications, case results, reviews, and required legal and insurance disclosures get built into the design, not treated as boilerplate at the bottom of the page. Forms integrate directly with LeadLogic or your existing intake system, so a completed form becomes an actionable lead immediately instead of sitting in an inbox.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "A site is only as good as how easy it is to update. We build on platforms and content structures your team can actually manage, so adding a new service page, updating a phone number, or publishing a new review doesn't need a developer for every small change.",
        ],
      },
      {
